	...
	public static void main(String[] args) throws SQLException {
		...
		while (continuer) {
			...
			case 1:
				...
				cptServ.listComputers(1).stream().forEach(System.out::println);
				String choix2;
				...
				while (continuer2) {
					...
					if ("s".equals(choix2) || "S".equals(choix2)) {
						cptServ.listComputers(i += 1).stream().forEach(System.out::println);
			...
			case 2:
				...
				cpnServ.listCompanies(1).stream().forEach(System.out::println);
				String choix3;
				...
				while (continuer3) {
					...
					if ("s".equals(choix3) || "S".equals(choix3)) {
						cpnServ.listCompanies(j += 1).stream().forEach(System.out::println);
